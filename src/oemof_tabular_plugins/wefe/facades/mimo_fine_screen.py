...
class MIMO_FineScreen(MIMO):
    """
    Specialized MIMO-B Fine Screen facade with code-driven physics.
    ...
    efficiency: float = 0.99                    # permeate / feedwater
