...
class MIMO_NanoFiltration(MIMO):
    """
    Specialized MIMO-B Nanofiltration facade with code-driven physics.
    ...
    # ---- physics parameters ----
    specific_energy_consumption: float = 0.5   # kWh / m³ treated water
