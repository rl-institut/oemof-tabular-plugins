...
class MIMO_UltraFiltration(MIMO):
    """
    Specialized MIMO-B Ultrafiltration facade with code-driven physics.
    ...
    # ---- physics parameters ----
    specific_energy_consumption: float = 0.25   # kWh / m³ treated water
