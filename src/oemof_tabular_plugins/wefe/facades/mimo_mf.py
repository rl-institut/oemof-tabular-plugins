...
class MIMO_MicroFiltration(MIMO):
    """
    Specialized MIMO-B Microfiltration facade with code-driven physics.
    ...
    # ---- physics parameters ----
    specific_energy_consumption: float = 0.20   # kWh / m³ treated water
