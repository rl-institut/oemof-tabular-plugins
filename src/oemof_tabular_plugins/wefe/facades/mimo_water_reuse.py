...
class MIMO_WaterReuseSystem(MIMO):
    """
    Specialized MIMO-B Water Reuse System facade with code-driven physics.
    ...
    # ---- physics ----
    specific_energy_consumption: float = 0.90   # kWh / m³ treated water
