...
class MIMO_DecentralizedWWTP(MIMO):
    """
    Specialized MIMO-B Decentralized WWTP facade with code-driven physics.
    ...
    # ---- tabular identity ----
    type: str = "mimo_decentralized_WWTP"
    name: str = ""
    tech: str = "mimo"
    carrier: str = ""
    primary: str = ""
    ...
    efficiency: float = 0.80                   # permeate / feedwater
