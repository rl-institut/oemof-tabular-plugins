...
class Electro_dialysisUnit(Converter, Facade):
    ...
    specific_energy_consumption: float
        Specific electricity demand/consumption in kWh per m³ treated water. Default: 0.9.
    efficiency: float
    ...
    specific_energy_consumption: float = 0.9  # kWh/m³
