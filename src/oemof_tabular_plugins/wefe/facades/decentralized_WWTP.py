...
class Decentralized_WWTP(Converter, Facade):
    r"""Decentralized waste water treatment plant unit with two inputs and two outputs.
    ...
    specific_energy_consumption: float
        Specific electricity demand/consumption in kWh per m³ treated water. Default: 0.35
    efficiency: float
    ...
    specific_energy_consumption: float = 0.35 # kWh/m³
