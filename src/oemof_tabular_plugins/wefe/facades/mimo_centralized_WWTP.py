...
class MIMO_CentralizedWWTP(MIMO):
    """
    Specialized MIMO-B Centralized WWTP facade with code-driven physics.
    ...
    # ---- tabular identity ----
    type: str = "mimo_centralized_WWTP"
    name: str = ""
    tech: str = "mimo"
    carrier: str = ""
    primary: str = ""
    ...
    # ---- physics parameters ----
    specific_energy_consumption: float = 1.0   # kWh / m³ treated water
    efficiency: float = 0.92                   # permeate / feedwater
