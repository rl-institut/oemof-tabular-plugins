...
class MIMO_CeramicFilter(MIMO):
    """
    Specialized MIMO-B Ceramic Filter facade with code-driven physics.
    ...
    # ---- physics ----
    specific_energy_consumption: float = 0.02   # kWh / m³ treated water
    efficiency: float = 0.97                    # permeate / feedwater
