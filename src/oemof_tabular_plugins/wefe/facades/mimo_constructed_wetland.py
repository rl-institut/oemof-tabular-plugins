...
class MIMO_ConstructedWetland(MIMO):
    """
    Specialized MIMO-B Constructed Wetland facade with code-driven physics.
    ...
    # ---- tabular identity ----
    type: str = "mimo_constructed_wetland"
    name: str = ""
    tech: str = "mimo"
    carrier: str = ""
    primary: str = ""
    ...
    # ---- physics ----
    specific_energy_consumption: float = 0.07   # kWh / m³ treated water (~0.0 ,if assumed gravity based)
    efficiency: float = 0.90                    # permeate / feedwater
