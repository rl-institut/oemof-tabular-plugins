...
class Grit_Chamber(Converter, Facade):
    r""" Grit chamber water pre-treatment unit with two inputs and one output.
        ...
        specific_energy_consumption: float
            Specific electricity demand/consumption in kWh per m³ treated water. Default: 0.015
        efficiency: float
    ...
    specific_energy_consumption: float = 0.015  # kWh/m³
