...
class GritChamber(Converter, Facade):
    r""" Grit chamber water pre-treatment unit with two inputs and one output.
        ...
        specific_energy_consumption: float
            Specific electricity demand/consumption in kWh per m³ treated water. Default: 0.01
        efficiency: float
            Share of untreated water that becomes treated water.
            Value between 0 and 1. Default: 0.985
        capacity: numeric
            The water pre-treatment capacity (output side) of the unit.
    ...
    specific_energy_consumption: float = 0.01  # kWh/m³
