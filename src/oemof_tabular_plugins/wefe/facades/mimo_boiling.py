...
class MIMO_Boiling(MIMO):
    """
    Specialized MIMO-B Boiling facade with code-driven physics.
    ...
    # ---- physics ----
    specific_energy_consumption: float = 0.80   # kWh / m³ treated water
