...
class MIMO_MembraneDistillation(MIMO):
    """
    Specialized MIMO-B Membrane Distillation facade with code-driven physics.
    ...
    # ---- physics parameters ----
    specific_energy_consumption: float = 5.0    # kWh / m³ treated water
