...
class MIMO_Chlorination(MIMO):
    """
    Specialized MIMO-B Chlorination facade with code-driven physics.
    ...
    def __init__(self, **attributes):
        ...
        # chlorine
        # ---------------------------
        self.chlorine_dose = attributes.pop("chlorine_dose", self.chlorine_dose)
        self.chlorine_cost = attributes.pop("chlorine_cost", self.chlorine_cost)

        # chlorine cost per m³ treated water
        chlorine_cost_per_m3 = (
                self.chlorine_dose * 1e-6 * self.chlorine_cost
        )
        ...
        attributes["output_parameters"].update(
            {
                ...
                "custom_attributes": {"chlorine_dose": self.chlorine_dose},
            }
        )
