...
class WaterReuse_System(Converter, Facade):
    r""" Water reuse and recycling unit with two inputs and one output.
    ...
    specific_energy_consumption: float
        Specific electricity demand/consumption in kWh per m³ treated water. Default: 0.90
    efficiency: float
