...
class MIMO_Photocatalysis(MIMO):
    """
    Specialized MIMO-B Photocatalytic unit facade with code-driven physics.
    ...
    Catalyst dosing is modeled as output-side variable cost.
    """

    # ---- tabular identity ----
    type: str = "mimo_photo_cat"
    name: str = ""
    tech: str = "mimo"
    carrier: str = ""
    primary: str = ""
    ...
    def __init__(self, **attributes):
        ...
        # catalyst
        # ---------------------------
        self.catalyst_dose = attributes.pop("catalyst_dose", self.catalyst_dose)
        self.catalyst_cost = attributes.pop("catalyst_cost", self.catalyst_cost)

        # catalyst cost per m³ treated water
        catalyst_cost_per_m3 = (
                self.catalyst_dose * 1e-6 * self.catalyst_cost
        )
